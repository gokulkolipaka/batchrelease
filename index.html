...
<head>
    ...
    <title>Enhanced Batch Release Agent - FDA Compliant</title>
...
<body>
            ...
            <form id="signup-form" class="auth-form">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="signup-firstname" class="form-control" required placeholder="Enter first name">
                    </div>
                    <div class="form-group">
                        <label for="signup-lastname" class="form-label">Last Name</label>
                        <input type="text" id="signup-lastname" class="form-control" required placeholder="Enter last name">
                    </div>
                </div>
                <div class="form-group">
                    <label for="signup-email" class="form-label">Email Address</label>
                    <input type="email" id="signup-email" class="form-control" required placeholder="Enter email address">
                </div>
                <div class="form-group">
                    <label for="signup-role" class="form-label">Role</label>
                    <select id="signup-role" class="form-control" required>
                        <option value="">Select your role</option>
                        <option value="qualified_person">Qualified Person (QP)</option>
                ...
                <div class="form-group">
                    ...
                    <div class="password-input-container">
                        <input type="password" id="signup-password" class="form-control" required placeholder="Create password">
                ...
                <div class="form-group">
                    ...
                    <div class="password-input-container">
                        <input type="password" id="signup-confirm-password" class="form-control" required placeholder="Confirm password">
        ...
        <div class="auth-card">
            ...
            <form id="forgot-password-form" class="auth-form">
                <div class="form-group">
                    ...
                    <input type="email" id="forgot-email" class="form-control" required placeholder="Enter your email address">
                </div>
                <button type="submit" class="btn btn--primary btn--full-width">
    ...
    <div id="password-change-modal" class="modal hidden">
        <div class="modal-content">
            <div class="modal-header">
                <h3><i class="fas fa-shield-alt"></i> Security Required: Change Password</h3>
            </div>
            <div class="modal-body">
                ...
                <form id="password-change-form" class="auth-form">
                    <div class="form-group">
                        ...
                        <div class="password-input-container">
                            <input type="password" id="new-password" class="form-control" required placeholder="Enter new password">
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-input-container">
                            <input type="password" id="confirm-new-password" class="form-control" required placeholder="Confirm new password">
    ...
    <div id="main-app" class="main-app hidden">
        ...
        <section id="dashboard" class="section">
            <div class="container">
                ...
                <div class="batch-list" id="dashboard-batch-list">
                    <!-- Batch cards will be populated here -->
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="filters-section">
                    <div class="search-container">
                        <input type="text" id="batch-search" class="form-control" placeholder="Search batches...">
                    </div>
            ...
            <div class="container">
                ...
                <div class="document-upload-section">
                    <div class="upload-area" id="upload-area">
                        ...
                        <input type="file" id="file-input" multiple accept=".pdf,.xlsx,.xls,.docx,.doc,.csv" hidden>
                    </div>
                </div>
        ...
        <!-- Compliance Section -->
        <section id="compliance" class="section hidden">
            <div class="container">
                <div class="section-header">
                ...
                <div class="compliance-grid">
                    ...
                    <div class="card">
                        <div class="card__body">
                            ...
                            <div class="signature-log" id="signature-log">
                                <!-- Signature entries will be populated here -->
                            </div>
                        </div>
                    </div>
        ...
        <section id="reports" class="section hidden">
            <div class="container">
                ...
                <div class="reports-grid">
                    <div class="card report-card" onclick="generateReport('batch-certificate')">
                        <div class="card__body">
                    ...
                    <div class="card report-card" onclick="generateReport('compliance-summary')">
                        <div class="card__body">
                    ...
                    <div class="card report-card" onclick="generateReport('audit-summary')">
                        <div class="card__body">
    ...
    <!-- Batch Detail Modal -->
    <div id="batch-detail-modal" class="modal hidden">
        <div class="modal-content">
            <div class="modal-header">
                <h3 id="batch-detail-title">Batch Details</h3>
                <button class="modal-close" onclick="closeBatchDetail()">&times;</button>
            </div>
